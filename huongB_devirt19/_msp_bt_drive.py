...
scr=sess.create_script(open("_msp_bt.js").read()); scr.on("message",on); scr.load()
...
disk_after=disk()
json.dump({"caps":caps,"before":disk_before,"after":disk_after},open("_msp_bt_out.json","w"),indent=1)
