...
scr=sess.create_script(open("_fulldump.js").read()); scr.on("message",on); scr.load()
...
disk_after=disk()
json.dump({"caps":caps,"before":disk_before,"after":disk_after},open("_fulldump_out.json","w"),indent=1)
