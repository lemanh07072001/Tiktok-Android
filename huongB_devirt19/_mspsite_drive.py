...
scr=sess.create_script(open("_mspsite.js").read()); scr.on("message",on); scr.load()
...
disk_after=disk()
json.dump({"caps":caps,"before":disk_before,"after":disk_after},open("_mspsite_out.json","w"),indent=1)
