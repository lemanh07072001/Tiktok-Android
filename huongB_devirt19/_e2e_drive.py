...
scr=sess.create_script(open("_e2e.js").read()); scr.on("message",on); scr.load()
...
disk_after=disk()
json.dump({"caps":caps,"before":disk_before,"after":disk_after},open("_e2e_out.json","w"),indent=1)
